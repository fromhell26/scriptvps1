...
# ==================================================
# Link Hosting Kalian
fromhell26="raw.githubusercontent.com/fromhell26/scriptvps/main/ipsec"
...
wget -O /usr/bin/addl2tp https://${fromhell26}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${fromhell26}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${fromhell26}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${fromhell26}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${fromhell26}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${fromhell26}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
touch /var/lib/fromhell26store/data-user-l2tp
touch /var/lib/fromhell26store/data-user-pptp
rm -f /root/ipsec.sh
