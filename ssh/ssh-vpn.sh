...
wget -O /home/vps/public_html/index.html "https://${fromhell26}/index.html1"
/etc/init.d/nginx restart
cd

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://${fromhell26}/badvpn-udpgw64"
...
mkdir -p /usr/local/fromhell26
mkdir -p /etc/fromhell26
...
[Service]
ExecStart=/usr/local/fromhell26/stunnel5 /etc/stunnel5/stunnel5.conf
Type=forking
